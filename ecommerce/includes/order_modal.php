    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Details of Order</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="edit_shipping" class="col-sm-3 control-label">Shipping Status</label>

                    <div class="col-sm-9">
                      <input type="shippingStatus" class="form-control" id="edit_shipping" name="shippingStatus" readonly="">
                    </div>
                </div>
